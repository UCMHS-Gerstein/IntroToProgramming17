...
Let’s say the branch on which you were working while sleeping is called ‘tired’ and you made three snapshots after you got home from the bar. If the name ‘tired’ points at the latest snapshot on that branch, then you can use a useful notation to refer to the parent of that snapshot. The notation ‘tired^’ means the parent of the snapshot pointed to by the branch name ‘tired’. Similarly ‘tired^^’ means the grandparent of the ‘tired’ snapshot. So the three snapshots in chronological order are ‘tired^^’, ‘tired^’, and ‘tired’.
